...
print(f"fuction: {programming_term['function']}")
print(f"collection: {programming_term['collection']}")
print(f"type: {programming_term['type']}")
print(f"iterator: {programming_term['iterator']}")
print(f"generator: {programming_term['generator']}")

print(f"fuction\n\t{programming_term['function']}")
print(f"collection\n\t{programming_term['collection']}")
print(f"type\n\t{programming_term['type']}")
print(f"iterator\n\t{programming_term['iterator']}")
print(f"generator\n\t{programming_term['generator']}")